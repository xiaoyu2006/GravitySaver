...
//  GravitySaver
//
//  Created by Yi on 2023/3/5.
//
//  Taken from https://github.com/AerialScreensaver/ScreenSaverMinimal/blob/master/ScreenSaverMinimal/Preferences.swift
        ...
        set {
            ...
            if let userDefaults = ScreenSaverDefaults(forModuleWithName: module) {
                ...
                if #available(OSX 10.12, *) {
                    ...
                    os_log("GravitySaver: %{public}@", log: log, type: .error, "UserDefaults set failed for \(key)")
                } else {
                    NSLog("GravitySaver: UserDefaults set failed for \(key)")
                }
            }
        }
    }
